...
class GatewayApplicationFlowTest : public ::testing::Test
{
  protected:
    GatewayApplicationFlowTest()
    {
        ...
        ON_CALL(generic_proxy_event_binding_factory_mock_guard_.factory_mock_, Create(::testing::_, ::testing::_))
            .WillByDefault(::testing::Invoke([this](impl::ProxyBase&, const std::string_view event_name) {

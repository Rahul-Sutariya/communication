...
{
  public:
    score::Result<void> Setup() override { return {}; }
    void Shutdown() override {}
    bool IsConnected() const override { return true; }
    score::Result<void> SendRequest(score::mw::com::gateway::TransportMessage& /*msg*/) override { return {}; }
    score::Result<void> SendNotification(score::mw::com::gateway::TransportMessage& /*msg*/) override { return {}; }
...
class TestGatewayCore final : public GatewayCore
{
  public:
    ...
    score::Result<void> OfferService(score::mw::com::impl::InstanceSpecifier /*s*/) override { return {}; }
...
int main()
{
    ...
    std::fprintf(stderr, "app2: BAR paddr=0x%llx size=0x%llx\n",
                 static_cast<unsigned long long>(paddr), static_cast<unsigned long long>(size));
    ...
    std::fprintf(stderr, "app2: waiting for service_a CTRL to appear in BAR directory...\n");
    {
        ...
        {
            std::fprintf(stderr, "app2: timed out waiting for service_a CTRL in directory\n");
            return 1;
        }
    }
    ...
    {
        std::fprintf(stderr, "app2: timed out waiting for service_a CTRL event_count\n");
        return 1;
    }
    ...
    {
        std::fprintf(stderr, "app2: service_a verification FAILED (magic=0x%08x d[1]=%u d[2]=%u)\n",
    ...
    {
        std::fprintf(stderr, "app2: timed out waiting for VM-A to verify service_b\n");
        return 1;
    }
